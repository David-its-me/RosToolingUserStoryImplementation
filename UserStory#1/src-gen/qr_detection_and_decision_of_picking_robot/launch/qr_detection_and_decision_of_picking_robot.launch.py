...
def generate_launch_description():
    ...
    moveit_simple_controller_joint_trajectory_controller_joints_arg = DeclareLaunchArgument(
        "moveit_simple_controller_joint_trajectory_controller_joints", default_value=TextSubstitution(text="[shoulder_pan_joint, shoulder_lift_joint, elbow_joint, wrist_1_joint, wrist_2_joint, wrist_3_joint]")
    )
